                ...
                <div class="x_content">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <?php if(!empty($ticket['ticket_contacts'])){
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="row activity-panel">
                        ...
                        <div class="activity col-md-12 <?= $activity['type']?>">
                            <div class="profile-img col-md-2 col-sm-2 col-xs-12 no-lr-padding">
                                <img class="img-responsive activity-avatar" src="<?= Url::toRoute("images/user-icon.png"); ?>" alt=""/>
                            </div>
                            <div class="activity-text col-md-10 col-sm-10 col-xs-12 no-lr-padding">
                                ...
                                <p><?= $activity['text']?></p>
                                <p><i class="fa fa-clock-o" aria-hidden="true"></i> <?= $activity['created_on']?>  </p>
                            </div>
                        </div>
                        <?php }?>
            ...
            <?php $form = ActiveForm::begin(['action'=>'update',"id" => "reply-form", 'options' => ['enctype' => 'multipart/form-data'],]); ?>
                    ...
                    <div class="user-select collapse" id="user-select">
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control col-md-7 col-xs-12" name="branch" data-dpr="depart_list" id="branch">
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control col-md-7 col-xs-12" name="depart" data-usr="user_list" id="depart_list">
