                ...
                <td style="display: block !important; max-width: 600px !important; margin: 0 auto !important;
                    ...
                    <div style="max-width: 600px; margin: 0 auto; display: block; padding: 20px;">
                        <table  style="background: #fff; border: 1px solid #e9e9e9; border-radius: 3px;" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding:60px 30px 30px 30px  !important; background:url(http://dev.osupport.opalina.in/img/td_mailler_logo.png) no-repeat 20px 20px;">
                        ...
                        <div style="  width: 100%;
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="padding: 0 0 20px;"><a  href="http://opalina.in/"><img width="150" src="<?= Yii::$app->params['baseUrl'] ?>/img/flogo.png"></a></td>
                                </tr>
                            </table>
                        </div></div>
                </td>
