                ...
                <td style="display: block !important; max-width: 600px !important; margin: 0 auto !important;
                    ...
                    <div style="max-width: 600px; margin: 0 auto; display: block; padding: 20px;">
                        <table  style="background: #fff; border: 1px solid #e9e9e9; border-radius: 3px;" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding:90px 30px 30px 30px  !important; background:url(<?= Yii::$app->params['baseUrl'] ?>images/td_logo_mailer.jpg) no-repeat 150px 0px;">
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 20px;">
                                                <div style=" font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif;
                                                     ...
                                                     margin:0;
                                                     line-height: 1.2;
                                                     font-weight:nornal; font-size:22px;"> Ticket forwarded to you </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0 0 20px; font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; color:#747474; font-size:16px;">
                                                User <?= $value->forwarded_by_name ?> has forwarded a ticket to you. Please click <a href="<?= $value->ticket_url ?>">here</a> to get started.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <div style="  width: 100%;
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="padding: 0 0 20px;"><a  href="http://opalina.in/"><img width="150" src="<?= Yii::$app->params['baseUrl'] ?>images/mailer_logo.png"></a></td>
                                </tr>
                            </table>
                        </div></div>
                </td>
