...
<div class="row">
    <div class="col-md-12">
        <?php if (Yii::$app->user->can('update-customer-info')) { ?>
...
<div class="row">
    ...
    <?php if (Yii::$app->user->can('view-subscription')) { ?>
        ...
        <?php $form = ActiveForm::begin(); ?>
                                    ...
                                    <div class="row">
        <?php if (Yii::$app->user->can('update-subscription-item')) { ?>
        ...
        <?php } ?>
                                        <button class="btn btn-primary load-item-data" data-amc="<?= $subscriptions[0]['ID'] ?>">Load Device Data</button>
    ...
    <script>
        var JS_SUB_IT_UP_PERM = <?= (Yii::$app->user->can('update-subscription-item')) ? "true" : "false"; ?>;
    </script>
            ...
            <div class="modal fade bd-example-modal-lg" id="pc-info-view-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
